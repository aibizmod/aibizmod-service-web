...
export function CardStack<T extends CardStackItem>({
  ...
  // Responsive state for scaling cards on mobile viewports
  const [screenSize, setScreenSize] = React.useState({ width: cardWidth, height: cardHeight });
              ...
              const dragProps = isActive
                ? {
                    ...
                    onDragEnd: (
                      ...
                      const threshold = Math.min(160, screenSize.width * 0.22);
