  ...
  const graph: Record<string, unknown>[] = [
    {
      ...
      category: 'Enterprise Software & AI Automation',
      ...
      audience: {
        '@type': 'Audience',
        audienceType: 'Chief Technology Officers, Engineering Directors, Technical Product Leaders',
      },
        ...
        <section className="relative isolate overflow-hidden px-6 pb-20 pt-32 md:pb-28 md:pt-36">
          ...
          <div className="relative z-10 mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
            ...
            >
              ...
              {/* Hero bullets */}
              <div
                className="mt-6 w-full max-w-2xl rounded-2xl border border-white/70 bg-white/45 px-6 py-4 shadow-[0_18px_55px_rgba(59,130,246,0.12)] backdrop-blur-md space-y-3"
              >
